...
#pragma warning restore 414
    ...
    public partial class ObjectTranslator
    {
        ...
        public ObjectTranslator(LuaEnv luaenv, RealStatePtr L)
        {
            ...
            addAssemblieByName(assemblies_usorted, "netstandard,");
            ...
            //添加c#需要的程序集合-方式2
            /**
            List<Assembly> elseAssemblies = new List<Assembly>();
            elseAssemblies.Add(Assembly.Load("mscorlib"));
            elseAssemblies.Add(Assembly.Load("System"));
            elseAssemblies.Add(Assembly.Load("System.Core"));
            elseAssemblies.Add(Assembly.Load("netstandard"));

            foreach (Assembly assembly in elseAssemblies)
            {
                if (!assemblies.Contains(assembly))
                {
                    assemblies.Add(assembly);
